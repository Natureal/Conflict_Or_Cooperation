...
def checkResult(conf):
    ...
    loss_filename = 'ELSTM/result/loss_' + suffix
...
def showResult(conf):
    ...
    loss_filename = 'ELSTM/result/loss_' + suffix
    ground_truth_filename = 'ELSTM/result/ground_truth_' + suffix
    model_result_filename = 'ELSTM/result/model_result_' + suffix
...
def saveResult(conf, trainer, loss_each_epoch, ground_truth, model_result):
    ...
    trainer_filename = 'ELSTM/result/trainer_' + suffix
