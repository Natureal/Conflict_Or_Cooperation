...
def checkResult(conf):
    ...
    loss_filename = 'EMLSTM/result/loss_' + suffix
...
def showResult(conf):
    ...
    loss_filename = 'EMLSTM/result/loss_' + suffix
    ground_truth_filename = 'EMLSTM/result/ground_truth_' + suffix
    model_result_filename = 'EMLSTM/result/model_result_' + suffix
...
def saveResult(conf, trainer, loss_each_epoch, ground_truth, model_result):
    ...
    trainer_filename = 'EMLSTM/result/trainer_' + suffix
